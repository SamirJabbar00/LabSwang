 ...
 * for details.
 */
public class GwtTestSimpleGwt extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "it.unibo.sweng.simplegwt.SimpleGwtJUnit";
  }
  ...
  public void testGreetingService() {
    ...
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "SimpleGwt/greet");
